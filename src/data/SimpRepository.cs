...
namespace HoloSimpID
{
    public partial class Simp
    {
        ...
        public static async Task<Simp?> TryGet(int uDex, Expression<Func<Simp, bool>>? predicate = null, AppDbContext? db = null)
        {
            predicate ??= _ => true;
            bool localContext = db == null;
            db ??= new AppDbContext();
        ...
        public static async Task<Simp?> TryGet(string userName, Expression<Func<Simp, bool>>? predicate = null, AppDbContext? db = null)
        {
            predicate ??= _ => true;
            bool localContext = db == null;
            db ??= new AppDbContext();
