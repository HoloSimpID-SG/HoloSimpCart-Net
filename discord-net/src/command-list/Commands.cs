  ...
  public static partial class CommandConsts {
    public static readonly SlashCommandBuilder[] commands = {
      ...
      new SlashCommandBuilder()
          ...
          // This is the tooltip for hints, can leave blank with "", or leave a Dad Joke Ina would
          // be proud of
      ...
      new SlashCommandBuilder()
          ...
          .WithDescription("Where's my Hina, Gio")
          .AddOption("only-open-carts", ApplicationCommandOptionType.Boolean,
                     "Where's my Hina, Gio", true),
      new SlashCommandBuilder()
      ...
      new SlashCommandBuilder()
          .WithName("bau-bau")
          .WithDescription("Where's my Hina, Gio")
          .AddOption("how-many", ApplicationCommandOptionType.Integer, "Where's my Hina, Gio",
                     true),
      //-+-+-+-+-+-+-+-+
      ...
      new SlashCommandBuilder()
          ...
          .AddOption("item-link", ApplicationCommandOptionType.String, "Where's my Hina, Gio",
                     false)
          .AddOption("item-price", ApplicationCommandOptionType.Number, "Where's my Hina, Gio",
                     false)
          .AddOption("quantity", ApplicationCommandOptionType.Integer, "Where's my Hina, Gio",
                     false),
      new SlashCommandBuilder()
      ...
      new SlashCommandBuilder().WithName("python-hello").WithDescription("For Keti and Mute"),
      new SlashCommandBuilder()
          .WithName("manim-text")
      ...
      new SlashCommandBuilder()
          .WithName("zig-hello")
          .WithDescription("Zig Supremacy, C++ Idiocracy")
          .AddOption("text", ApplicationCommandOptionType.String, "Where's my Hina, Gio", false),
      new SlashCommandBuilder()
          .WithName("cpp-hello")
          .WithDescription("Zig Supremacy, C++ Idiocracy")
