    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uDex = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Simps", x => x.uDex);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePlan = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Simps_OwnerDex",
                        column: x => x.OwnerDex,
                        principalTable: "Simps",
                        principalColumn: "uDex",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    cartDex = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Carts_cartDex",
                        column: x => x.cartDex,
                        principalTable: "Carts",
                        principalColumn: "uDex",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Simps_simpDex",
                        column: x => x.simpDex,
                        principalTable: "Simps",
                        principalColumn: "uDex",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_simpDex",
                table: "CartItems",
                column: "simpDex");

            migrationBuilder.CreateIndex(
                name: "IX_Carts_OwnerDex",
                table: "Carts",
                column: "OwnerDex");
        }
